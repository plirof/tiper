...
/***/ function(module, exports) {
	...
	var dictionary = {
	    words: [
	        "+1",
			"τρέξιμο","τρέχει","τραγουδώ","τραγούδι","τραπέζι",
			"τροφή","τρύπα","τρώω","τσάι","τσάντα",
			"τσέπη","τυρί","τυφλός","τώρα","υγιής",
			"μεσημεριανό","μετά","μετανάστευση","μεταφορά","μετρητής",
			"μητέρα","μικρά","μικρός","μιλήσετε","μιλώ",
			"μισός","μολύβι","μουσική","μπάλα","μπάντα",
			"μπανάνα","μπαρ","μπλε","μπορώ","μπουκάλι",
			"μπράτσο","μπύρα","μυρμήγκι","μυρωδιά","μωρό",
			"μόλις","μόνο","μύγα","μύτη","νέος",
			"νίκη","ναι","νεκρός","νερό","νησί",
			"νικήσει","νοιώθω","νομίζω","νομοσχέδιο","νοσοκομείο",
			"νόσος","νότια","νύχτα","ξέρω","ξανά",
			"ξαπλώνω","ξενοδοχείο","ξυπνήστε","ξύλο","οίκος",
			"οδηγώ","οθόνη","οικογένεια","ομάδα","οροφή",
	        "trust fund",
	        "try-hard",
	        "Tumblr",
	        "typewriter",
	 ...
	 */
	   ...
	   */
	            this.toCharacter = function (keyCode, shift) {
	            	console.log('toCharacter   keyCode  ='+keyCode);
	   ...
	   */
	            this.charCodeToCharacter = function (charCode) {
	            	console.log('charCodeToCharacter  charCode  ='+charCode);
	   ...
	   */
	            this.eventToCharacter = function (event) {
	            	console.log((event)); //jon OK greek letter here step01
